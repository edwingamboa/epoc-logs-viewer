...
(function () {
  ...
  function changeDataOfTrendChart (pmId) {
  ...
  function appendRBtnsForTrendChart() {
    pmLogsInfo.get('pmIds').forEach(function (pmId) {
      ...
      var pmLabel = createLabelElement(pmId, 'trendChartPM', pmId === DEFAULT_TREND_CHART_PM_ID);
      var trendChartRBtnsDiv = document.querySelector('#' + TREND_CHART_R_BTNS_DIV_ID);
      trendChartRBtnsDiv.appendChild(pmInput);
      trendChartRBtnsDiv.appendChild(pmLabel);
    });
    ...
    function createLabelElement (id) {
      ...
      labelEl.innerHTML = id + ' ' + pmLogsInfo.get(id).verbose;
      return labelEl;
    }
  }
}());
